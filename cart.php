        ...
        <div class="ps-cart-listing">
          <div class="table-responsive">
            <table class="table ps-table ps-table--listing">
              ...
              <tbody>
              <?php echo '<a href="javascript:window.print()">IMPRIMER CETTE PAGE OU CETTE SELECTION</a>'; ?>
                <?php
                  $t = '<tr>
                  <td><a class="ps-product--table" href="product-detail.html"><img class="mr-15" src="images/products/1.png" alt=""> Air jordan One mid</a></td>
                  <td>$150</td>
                  <td>
          ...
          <div class="ps-cart__actions">
            ...
            <--!on aura du code php a implementer--!>
            <div class="ps-cart__total">
              <h3>Total Price: <span> 2599.00 $</span></h3><a class="ps-btn" href="../order-form.html">Process to checkout</a>
            </div>
          </div>
        </div>
      </div>
